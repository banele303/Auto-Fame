...
import { ArrowLeft, Check, DollarSign, Heart, Share2, Calendar, Gauge, Fuel, Car, Phone, Mail } from "lucide-react";
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        ...
        text: `Check out this ${car?.year} ${car?.make} ${car?.model} for ${formatPrice(car?.price || 0)} at AutoFame`,
            ...
            <Card className="mt-2 border-gray-200 dark:border-gray-700">
              ...
              <CardContent>
                ...
                {car.features && car.features.length > 0 && (
                  <div className="mt-8">
                    <h3 className="text-lg font-semibold mb-3">Vehicle Extras & Features</h3>
                ...
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <h2 className="text-2xl sm:text-3xl font-display font-extrabold text-gray-900 dark:text-white">
                      Recent Vehicles in Johannesburg South
                    </h2>
                  </div>
                  <button
                  ...
                  <div className="mb-6">
                    ...
                    {car.price > 0 && (
                      <div className="rounded-2xl border border-gray-200 dark:border-gray-700 p-5 bg-white dark:bg-gray-800/70 shadow-sm">
                        ...
                        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Available at 1 Rifle Range Rd, Baragwanath.</p>
                        <div className="mt-5 grid grid-cols-2 gap-3">
                          ...
                          >
                            ...
                            <span className="text-sm">{showNumber ? siteConfig.contact.phoneDisplay : 'Show number'}</span>
                          </Button>
                          <Button
                            type="button"
                          ...
                          <Button
                            type="button"
                            onClick={() => {
                              const waNumber = siteConfig.contact.whatsappNumberRaw;
                              const url = `https://wa.me/${waNumber}?text=${encodeURIComponent('Hi AutoFame, I am interested in the '+car.year+' '+car.make+' '+car.model)}`;
                              window.open(url,'_blank','noopener');
                            }}
                            className="col-span-2 bg-[#0a5c48] hover:bg-[#084c3c] text-white font-semibold flex items-center justify-center gap-2"
                          >
                            <span className="text-sm font-semibold">WhatsApp Dealership</span>
                          </Button>
                          <Button
                            type="button"
                          ...
                          >
                            ...
                            <span className="text-sm font-semibold">Apply for Bank Finance</span>
                          </Button>
                        </div>
                      </div>
                    )}
