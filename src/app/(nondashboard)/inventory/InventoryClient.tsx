      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex justify-between items-center mb-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
                Used Cars For Sale in Johannesburg South
              </h1>
              <p className="text-gray-600 dark:text-gray-400 mt-2">
                Explore quality verified pre-owned vehicles, sedans, SUVs, and bakkies at 1 Rifle Range Rd, Baragwanath.
              </p>
            </div>
          </div>
        ...
        <div className="flex justify-between items-center mb-6">
          <p className="text-gray-600 dark:text-gray-400">
            Showing {filteredCars.length} vehicle{filteredCars.length !== 1 ? 's' : ''} in Johannesburg South
          </p>
        </div>
        ...
        {filteredCars.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-600 dark:text-gray-400 text-lg mb-4">
              No vehicles found matching your criteria in Johannesburg South
            </p>
            <Button 
              onClick={() => {
                setSearchQuery("");
